 ...
 */
@JsonPropertyOrder({
  ProductListingCriteria.JSON_PROPERTY_PAGE,
  ProductListingCriteria.JSON_PROPERTY_LIMIT,
  ProductListingCriteria.JSON_PROPERTY_FILTER,
  ProductListingCriteria.JSON_PROPERTY_SORT,
  ProductListingCriteria.JSON_PROPERTY_POST_FILTER,
  ProductListingCriteria.JSON_PROPERTY_ASSOCIATIONS,
  ProductListingCriteria.JSON_PROPERTY_AGGREGATIONS,
  ProductListingCriteria.JSON_PROPERTY_GROUPING,
  ProductListingCriteria.JSON_PROPERTY_FIELDS,
  ProductListingCriteria.JSON_PROPERTY_TOTAL_COUNT_MODE,
  ProductListingCriteria.JSON_PROPERTY_ORDER,
  ProductListingCriteria.JSON_PROPERTY_P,
  ProductListingCriteria.JSON_PROPERTY_MANUFACTURER,
  ProductListingCriteria.JSON_PROPERTY_MIN_PRICE,
  ProductListingCriteria.JSON_PROPERTY_MAX_PRICE,
  ProductListingCriteria.JSON_PROPERTY_RATING,
  ProductListingCriteria.JSON_PROPERTY_SHIPPING_FREE,
  ProductListingCriteria.JSON_PROPERTY_PROPERTIES,
  ProductListingCriteria.JSON_PROPERTY_MANUFACTURER_FILTER,
  ProductListingCriteria.JSON_PROPERTY_PRICE_FILTER,
  ProductListingCriteria.JSON_PROPERTY_RATING_FILTER,
  ProductListingCriteria.JSON_PROPERTY_SHIPPING_FREE_FILTER,
  ProductListingCriteria.JSON_PROPERTY_PROPERTY_FILTER,
  ProductListingCriteria.JSON_PROPERTY_PROPERTY_WHITELIST,
  ProductListingCriteria.JSON_PROPERTY_REDUCE_AGGREGATIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-06-10T11:26:02.541008353+02:00[Europe/Berlin]", comments = "Generator version: 7.5.0")
public class ProductListingCriteria {
  ...
  public ProductListingCriteria() {
  }

  public ProductListingCriteria page(Integer page) {
  ...
  **/
  ...
  public ProductListingCriteria limit(Integer limit) {
  ...
  **/
  ...
  public ProductListingCriteria filter(List<CriteriaFilterInner> filter) {
    
    this.filter = filter;
    return this;
  }

  public ProductListingCriteria addFilterItem(CriteriaFilterInner filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ProductListingCriteria sort(List<CriteriaSortInner> sort) {
    
    this.sort = sort;
    return this;
  }

  public ProductListingCriteria addSortItem(CriteriaSortInner sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public ProductListingCriteria postFilter(List<CriteriaFilterInner> postFilter) {
    
    this.postFilter = postFilter;
    return this;
  }

  public ProductListingCriteria addPostFilterItem(CriteriaFilterInner postFilterItem) {
  ...
  **/
  ...
  public ProductListingCriteria associations(Object associations) {
  ...
  **/
  ...
  public ProductListingCriteria aggregations(List<CriteriaAggregationsInner> aggregations) {
    
    this.aggregations = aggregations;
    return this;
  }

  public ProductListingCriteria addAggregationsItem(CriteriaAggregationsInner aggregationsItem) {
  ...
  **/
  ...
  public ProductListingCriteria grouping(List<String> grouping) {
    
    this.grouping = grouping;
    return this;
  }

  public ProductListingCriteria addGroupingItem(String groupingItem) {
  ...
  **/
  ...
  public ProductListingCriteria fields(List<String> fields) {
    
    this.fields = fields;
    return this;
  }

  public ProductListingCriteria addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public ProductListingCriteria totalCountMode(TotalCountModeEnum totalCountMode) {
  ...
  **/
  ...
  public ProductListingCriteria order(String order) {
  ...
  **/
  ...
  public ProductListingCriteria p(Integer p) {
  ...
  **/
  ...
  public ProductListingCriteria manufacturer(String manufacturer) {
  ...
  **/
  ...
  public ProductListingCriteria minPrice(Integer minPrice) {
  ...
  **/
  ...
  public ProductListingCriteria maxPrice(Integer maxPrice) {
  ...
  **/
  ...
  public ProductListingCriteria rating(Integer rating) {
  ...
  **/
  ...
  public ProductListingCriteria shippingFree(Boolean shippingFree) {
  ...
  **/
  ...
  public ProductListingCriteria properties(String properties) {
  ...
  **/
  ...
  public ProductListingCriteria manufacturerFilter(Boolean manufacturerFilter) {
  ...
  **/
  ...
  public ProductListingCriteria priceFilter(Boolean priceFilter) {
  ...
  **/
  ...
  public ProductListingCriteria ratingFilter(Boolean ratingFilter) {
  ...
  **/
  ...
  public ProductListingCriteria shippingFreeFilter(Boolean shippingFreeFilter) {
  ...
  **/
  ...
  public ProductListingCriteria propertyFilter(Boolean propertyFilter) {
  ...
  **/
  ...
  public ProductListingCriteria propertyWhitelist(String propertyWhitelist) {
  ...
  **/
  ...
  public ProductListingCriteria reduceAggregations(String reduceAggregations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductListingCriteria productListingCriteria = (ProductListingCriteria) o;
    return Objects.equals(this.page, productListingCriteria.page) &&
        Objects.equals(this.limit, productListingCriteria.limit) &&
        Objects.equals(this.filter, productListingCriteria.filter) &&
        Objects.equals(this.sort, productListingCriteria.sort) &&
        Objects.equals(this.postFilter, productListingCriteria.postFilter) &&
        Objects.equals(this.associations, productListingCriteria.associations) &&
        Objects.equals(this.aggregations, productListingCriteria.aggregations) &&
        Objects.equals(this.grouping, productListingCriteria.grouping) &&
        Objects.equals(this.fields, productListingCriteria.fields) &&
        Objects.equals(this.totalCountMode, productListingCriteria.totalCountMode) &&
        Objects.equals(this.order, productListingCriteria.order) &&
        Objects.equals(this.p, productListingCriteria.p) &&
        Objects.equals(this.manufacturer, productListingCriteria.manufacturer) &&
        Objects.equals(this.minPrice, productListingCriteria.minPrice) &&
        Objects.equals(this.maxPrice, productListingCriteria.maxPrice) &&
        Objects.equals(this.rating, productListingCriteria.rating) &&
        Objects.equals(this.shippingFree, productListingCriteria.shippingFree) &&
        Objects.equals(this.properties, productListingCriteria.properties) &&
        Objects.equals(this.manufacturerFilter, productListingCriteria.manufacturerFilter) &&
        Objects.equals(this.priceFilter, productListingCriteria.priceFilter) &&
        Objects.equals(this.ratingFilter, productListingCriteria.ratingFilter) &&
        Objects.equals(this.shippingFreeFilter, productListingCriteria.shippingFreeFilter) &&
        Objects.equals(this.propertyFilter, productListingCriteria.propertyFilter) &&
        Objects.equals(this.propertyWhitelist, productListingCriteria.propertyWhitelist) &&
        equalsNullable(this.reduceAggregations, productListingCriteria.reduceAggregations);
  }
