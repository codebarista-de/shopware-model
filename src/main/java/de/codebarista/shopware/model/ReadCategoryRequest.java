 ...
 */
@JsonPropertyOrder({
  ReadCategoryRequest.JSON_PROPERTY_PAGE,
  ReadCategoryRequest.JSON_PROPERTY_LIMIT,
  ReadCategoryRequest.JSON_PROPERTY_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_SORT,
  ReadCategoryRequest.JSON_PROPERTY_POST_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_ASSOCIATIONS,
  ReadCategoryRequest.JSON_PROPERTY_AGGREGATIONS,
  ReadCategoryRequest.JSON_PROPERTY_GROUPING,
  ReadCategoryRequest.JSON_PROPERTY_FIELDS,
  ReadCategoryRequest.JSON_PROPERTY_TOTAL_COUNT_MODE,
  ReadCategoryRequest.JSON_PROPERTY_ORDER,
  ReadCategoryRequest.JSON_PROPERTY_P,
  ReadCategoryRequest.JSON_PROPERTY_MANUFACTURER,
  ReadCategoryRequest.JSON_PROPERTY_MIN_PRICE,
  ReadCategoryRequest.JSON_PROPERTY_MAX_PRICE,
  ReadCategoryRequest.JSON_PROPERTY_RATING,
  ReadCategoryRequest.JSON_PROPERTY_SHIPPING_FREE,
  ReadCategoryRequest.JSON_PROPERTY_PROPERTIES,
  ReadCategoryRequest.JSON_PROPERTY_MANUFACTURER_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_PRICE_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_RATING_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_SHIPPING_FREE_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_PROPERTY_FILTER,
  ReadCategoryRequest.JSON_PROPERTY_PROPERTY_WHITELIST,
  ReadCategoryRequest.JSON_PROPERTY_REDUCE_AGGREGATIONS
})
@JsonTypeName("readCategory_request")
...
public class ReadCategoryRequest {
  ...
  public ReadCategoryRequest page(Integer page) {
  ...
  **/
  ...
  public ReadCategoryRequest limit(Integer limit) {
  ...
  **/
  ...
  public ReadCategoryRequest filter(List<CriteriaFilterInner> filter) {
    
    this.filter = filter;
    return this;
  }

  public ReadCategoryRequest addFilterItem(CriteriaFilterInner filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ReadCategoryRequest sort(List<CriteriaSortInner> sort) {
    
    this.sort = sort;
    return this;
  }

  public ReadCategoryRequest addSortItem(CriteriaSortInner sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public ReadCategoryRequest postFilter(List<CriteriaFilterInner> postFilter) {
    
    this.postFilter = postFilter;
    return this;
  }

  public ReadCategoryRequest addPostFilterItem(CriteriaFilterInner postFilterItem) {
  ...
  **/
  ...
  public ReadCategoryRequest associations(Object associations) {
  ...
  **/
  ...
  public ReadCategoryRequest aggregations(List<CriteriaAggregationsInner> aggregations) {
    
    this.aggregations = aggregations;
    return this;
  }

  public ReadCategoryRequest addAggregationsItem(CriteriaAggregationsInner aggregationsItem) {
  ...
  **/
  ...
  public ReadCategoryRequest grouping(List<String> grouping) {
    
    this.grouping = grouping;
    return this;
  }

  public ReadCategoryRequest addGroupingItem(String groupingItem) {
  ...
  **/
  ...
  public ReadCategoryRequest fields(List<String> fields) {
    
    this.fields = fields;
    return this;
  }

  public ReadCategoryRequest addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public ReadCategoryRequest totalCountMode(TotalCountModeEnum totalCountMode) {
  ...
  **/
  ...
  public ReadCategoryRequest order(String order) {
  ...
  **/
  ...
  public ReadCategoryRequest p(Integer p) {
  ...
  **/
  ...
  public ReadCategoryRequest manufacturer(String manufacturer) {
  ...
  **/
  ...
  public ReadCategoryRequest minPrice(Integer minPrice) {
  ...
  **/
  ...
  public ReadCategoryRequest maxPrice(Integer maxPrice) {
  ...
  **/
  ...
  public ReadCategoryRequest rating(Integer rating) {
  ...
  **/
  ...
  public ReadCategoryRequest shippingFree(Boolean shippingFree) {
  ...
  **/
  ...
  public ReadCategoryRequest properties(String properties) {
  ...
  **/
  ...
  public ReadCategoryRequest manufacturerFilter(Boolean manufacturerFilter) {
  ...
  **/
  ...
  public ReadCategoryRequest priceFilter(Boolean priceFilter) {
  ...
  **/
  ...
  public ReadCategoryRequest ratingFilter(Boolean ratingFilter) {
  ...
  **/
  ...
  public ReadCategoryRequest shippingFreeFilter(Boolean shippingFreeFilter) {
  ...
  **/
  ...
  public ReadCategoryRequest propertyFilter(Boolean propertyFilter) {
  ...
  **/
  ...
  public ReadCategoryRequest propertyWhitelist(String propertyWhitelist) {
  ...
  **/
  ...
  public ReadCategoryRequest reduceAggregations(String reduceAggregations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReadCategoryRequest readCategoryRequest = (ReadCategoryRequest) o;
    return Objects.equals(this.page, readCategoryRequest.page) &&
        Objects.equals(this.limit, readCategoryRequest.limit) &&
        Objects.equals(this.filter, readCategoryRequest.filter) &&
        Objects.equals(this.sort, readCategoryRequest.sort) &&
        Objects.equals(this.postFilter, readCategoryRequest.postFilter) &&
        Objects.equals(this.associations, readCategoryRequest.associations) &&
        Objects.equals(this.aggregations, readCategoryRequest.aggregations) &&
        Objects.equals(this.grouping, readCategoryRequest.grouping) &&
        Objects.equals(this.fields, readCategoryRequest.fields) &&
        Objects.equals(this.totalCountMode, readCategoryRequest.totalCountMode) &&
        Objects.equals(this.order, readCategoryRequest.order) &&
        Objects.equals(this.p, readCategoryRequest.p) &&
        Objects.equals(this.manufacturer, readCategoryRequest.manufacturer) &&
        Objects.equals(this.minPrice, readCategoryRequest.minPrice) &&
        Objects.equals(this.maxPrice, readCategoryRequest.maxPrice) &&
        Objects.equals(this.rating, readCategoryRequest.rating) &&
        Objects.equals(this.shippingFree, readCategoryRequest.shippingFree) &&
        Objects.equals(this.properties, readCategoryRequest.properties) &&
        Objects.equals(this.manufacturerFilter, readCategoryRequest.manufacturerFilter) &&
        Objects.equals(this.priceFilter, readCategoryRequest.priceFilter) &&
        Objects.equals(this.ratingFilter, readCategoryRequest.ratingFilter) &&
        Objects.equals(this.shippingFreeFilter, readCategoryRequest.shippingFreeFilter) &&
        Objects.equals(this.propertyFilter, readCategoryRequest.propertyFilter) &&
        Objects.equals(this.propertyWhitelist, readCategoryRequest.propertyWhitelist) &&
        equalsNullable(this.reduceAggregations, readCategoryRequest.reduceAggregations);
  }
