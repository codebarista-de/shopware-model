 ...
 */
@JsonPropertyOrder({
  ReadNavigationRequest.JSON_PROPERTY_PAGE,
  ReadNavigationRequest.JSON_PROPERTY_LIMIT,
  ReadNavigationRequest.JSON_PROPERTY_FILTER,
  ReadNavigationRequest.JSON_PROPERTY_SORT,
  ReadNavigationRequest.JSON_PROPERTY_POST_FILTER,
  ReadNavigationRequest.JSON_PROPERTY_ASSOCIATIONS,
  ReadNavigationRequest.JSON_PROPERTY_AGGREGATIONS,
  ReadNavigationRequest.JSON_PROPERTY_GROUPING,
  ReadNavigationRequest.JSON_PROPERTY_FIELDS,
  ReadNavigationRequest.JSON_PROPERTY_TOTAL_COUNT_MODE,
  ReadNavigationRequest.JSON_PROPERTY_DEPTH,
  ReadNavigationRequest.JSON_PROPERTY_BUILD_TREE
})
@JsonTypeName("readNavigation_request")
...
public class ReadNavigationRequest {
  ...
  public static final String JSON_PROPERTY_BUILD_TREE = "buildTree";
  private List<Object> buildTree = new ArrayList<>();

  public ReadNavigationRequest() {
  }

  public ReadNavigationRequest page(Integer page) {
  ...
  **/
  ...
  public ReadNavigationRequest limit(Integer limit) {
  ...
  **/
  ...
  public ReadNavigationRequest filter(List<CriteriaFilterInner> filter) {
    
    this.filter = filter;
    return this;
  }

  public ReadNavigationRequest addFilterItem(CriteriaFilterInner filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ReadNavigationRequest sort(List<CriteriaSortInner> sort) {
    
    this.sort = sort;
    return this;
  }

  public ReadNavigationRequest addSortItem(CriteriaSortInner sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public ReadNavigationRequest postFilter(List<CriteriaFilterInner> postFilter) {
    
    this.postFilter = postFilter;
    return this;
  }

  public ReadNavigationRequest addPostFilterItem(CriteriaFilterInner postFilterItem) {
  ...
  **/
  ...
  public ReadNavigationRequest associations(Object associations) {
  ...
  **/
  ...
  public ReadNavigationRequest aggregations(List<CriteriaAggregationsInner> aggregations) {
    
    this.aggregations = aggregations;
    return this;
  }

  public ReadNavigationRequest addAggregationsItem(CriteriaAggregationsInner aggregationsItem) {
  ...
  **/
  ...
  public ReadNavigationRequest grouping(List<String> grouping) {
    
    this.grouping = grouping;
    return this;
  }

  public ReadNavigationRequest addGroupingItem(String groupingItem) {
  ...
  **/
  ...
  public ReadNavigationRequest fields(List<String> fields) {
    
    this.fields = fields;
    return this;
  }

  public ReadNavigationRequest addFieldsItem(String fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public ReadNavigationRequest totalCountMode(TotalCountModeEnum totalCountMode) {
  ...
  **/
  ...
  public ReadNavigationRequest depth(Integer depth) {
  ...
  **/
  ...
  public ReadNavigationRequest buildTree(List<Object> buildTree) {
    
    this.buildTree = buildTree;
    return this;
  }

  public ReadNavigationRequest addBuildTreeItem(Object buildTreeItem) {
    if (this.buildTree == null) {
      this.buildTree = new ArrayList<>();
    }
    this.buildTree.add(buildTreeItem);
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BUILD_TREE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBuildTree(List<Object> buildTree) {
    this.buildTree = buildTree;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReadNavigationRequest readNavigationRequest = (ReadNavigationRequest) o;
    return Objects.equals(this.page, readNavigationRequest.page) &&
        Objects.equals(this.limit, readNavigationRequest.limit) &&
        Objects.equals(this.filter, readNavigationRequest.filter) &&
        Objects.equals(this.sort, readNavigationRequest.sort) &&
        Objects.equals(this.postFilter, readNavigationRequest.postFilter) &&
        Objects.equals(this.associations, readNavigationRequest.associations) &&
        Objects.equals(this.aggregations, readNavigationRequest.aggregations) &&
        Objects.equals(this.grouping, readNavigationRequest.grouping) &&
        Objects.equals(this.fields, readNavigationRequest.fields) &&
        Objects.equals(this.totalCountMode, readNavigationRequest.totalCountMode) &&
        Objects.equals(this.depth, readNavigationRequest.depth) &&
        Objects.equals(this.buildTree, readNavigationRequest.buildTree);
  }

  @Override
  public int hashCode() {
    return Objects.hash(page, limit, filter, sort, postFilter, associations, aggregations, grouping, fields, totalCountMode, depth, buildTree);
  }
  ...
  public String toString() {
    ...
    sb.append("    buildTree: ").append(toIndentedString(buildTree)).append("\n");
    sb.append("}");
    return sb.toString();
  }
